...
var isAnagram = function (s, t) {
  ...
  for (const char of s) {
    charCount[char.charCodeAt(0) - "a".charCodeAt(0)]++; // Increment count for character in s
  }

  for (const char of t) {
    charCount[char.charCodeAt(0) - "a".charCodeAt(0)]--; // Decrement count for character in t
  }
